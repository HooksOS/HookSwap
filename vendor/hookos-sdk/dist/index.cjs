...
function create2Address(deployer, salt, initCodeHash) {
  const hash = viem.keccak256(viem.concat(["0xff", deployer, salt, initCodeHash]));
  return viem.getAddress(viem.slice(hash, 12));
}
var V3LaunchModule = class {
  ...
  async mineSalt(p, opts = {}) {
    ...
    for (let i = 1; i < limit; i++) {
      const salt = viem.pad(viem.toHex(i), { size: 32 });
...
function computeFairLaunchParams(opts) {
  ...
  return {
    ...
    tickLower,
    tickUpper,
    liquidityDelta: viem.parseEther(L.toFixed(18)),
    seedTick,
    derivedMcapUsd
  };
}
...
var StockRewardModule = class {
  ...
  async buildLaunchParamsV4(opts) {
    ...
    const predictedToken = viem.getContractAddress({ from: launcher, nonce: BigInt(nonce) });
    ...
    if (opts.devBuyEth && opts.devBuyEth > 0) {
      initialBuyEth = viem.parseEther(opts.devBuyEth.toString());
      const nativeUsdFloat = Number(nativeUsdPrice) / 1e18;
      ...
      if (seedPriceNative > 0) {
        const expectedTokens = Number(viem.formatEther(initialBuyEth)) / seedPriceNative;
        const floorTokens = expectedTokens * 0.5;
        if (Number.isFinite(floorTokens) && floorTokens > 0) initialBuyMinOut = viem.parseEther(floorTokens.toFixed(18));
      }
  ...
  async launch(opts) {
    ...
    const predictedToken = viem.getContractAddress({ from: a.launcherV2, nonce: BigInt(nonce) });
    const tokenIsZero = predictedToken.toLowerCase() < weth.toLowerCase();
    const { nativeUsdPrice } = await this.readKeeperPrice(a.bondingCurve);
  ...
  async launchV4(params, value) {
    ...
    for (const log of receipt.logs) {
      try {
        const decoded = viem.decodeEventLog({ abi: StockRewardLauncherV4ABI, data: log.data, topics: log.topics });
  ...
  async launchV2(params, predictedToken) {
    ...
    for (const log of receipt.logs) {
      try {
        const decoded = viem.decodeEventLog({ abi: StockRewardLauncherV2ABI, data: log.data, topics: log.topics });
        if (decoded.eventName === "Launched") {
          const args = decoded.args;
          token = args.token;
          pool = args.pool;
...
var QuickLaunchModule = class {
  ...
  async buildLaunchParams(opts) {
    ...
    const predictedToken = viem.getContractAddress({ from: a.launchpad, nonce: BigInt(nonce) });
  ...
  async launch(opts) {
    ...
    for (const log of receipt.logs) {
      try {
        const decoded = viem.decodeEventLog({ abi: RHLaunchpadABI, data: log.data, topics: log.topics });
        if (decoded.eventName === "TokenCreated") {
  ...
  async devBuy(opts) {
    ...
    const amountIn = viem.parseEther(opts.amountInEther.toString());
    const hash = await this.walletClient.writeContract({
      address: a.launchpad,
      abi: RHLaunchpadABI,
      functionName: "devBuy",
...
exports.ArenaABI = ArenaABI;
exports.ArenaModule = ArenaModule;
exports.BattleStatus = BattleStatus;
exports.BondingCurveABI = BondingCurveABI;
exports.CREATOR_FEE_BPS = CREATOR_FEE_BPS;
exports.ChainError = ChainError;
exports.ContractCallError = ContractCallError;
exports.DEFAULT_REWARD_SYMBOL = DEFAULT_REWARD_SYMBOL;
exports.DEFAULT_TAX_BPS = DEFAULT_TAX_BPS;
exports.EventStatus = EventStatus;
exports.EventsABI = EventsABI;
exports.EventsModule = EventsModule;
exports.FIXED_CUT_BPS = FIXED_CUT_BPS;
exports.FLYWHEEL_BPS = FLYWHEEL_BPS;
exports.FeeModule = FeeModule;
exports.FeeRouterABI = FeeRouterABI;
exports.FeedBoostAuctionABI = FeedBoostAuctionABI;
exports.FeedBoostModule = FeedBoostModule;
exports.HOOKOS_V3_ADDRESSES = HOOKOS_V3_ADDRESSES;
exports.HOOKOS_V3_ADDRESSES_BY_CHAIN = HOOKOS_V3_ADDRESSES_BY_CHAIN;
exports.HOOKOS_V3_CHAIN_ID = HOOKOS_V3_CHAIN_ID;
exports.HOOKOS_V3_SUPPORTED_CHAIN_IDS = HOOKOS_V3_SUPPORTED_CHAIN_IDS;
exports.HookManagerABI = HookManagerABI;
exports.HookModule = HookModule;
exports.HookOS = HookOS;
exports.HookOSError = HookOSError;
exports.HookOSV3BuybackABI = HookOSV3BuybackABI;
exports.HookOSV3FeeVaultABI = HookOSV3FeeVaultABI;
exports.HookOSV3LauncherABI = HookOSV3LauncherABI;
exports.HookPoint = HookPoint;
exports.HookRegistryABI = HookRegistryABI;
exports.IndexerError = IndexerError;
exports.MAX_SQRT_RATIO = MAX_SQRT_RATIO;
exports.MAX_TAX_BPS = MAX_TAX_BPS;
exports.MIN_SQRT_RATIO = MIN_SQRT_RATIO;
exports.MIN_TAX_BPS = MIN_TAX_BPS;
exports.MerkleStockDistributorABI = MerkleStockDistributorABI;
exports.PLATFORM_NET_BPS = PLATFORM_NET_BPS;
exports.QUICK_LAUNCH_ADDRESSES = QUICK_LAUNCH_ADDRESSES;
exports.QUICK_LAUNCH_CHAIN_ID = QUICK_LAUNCH_CHAIN_ID;
exports.QUICK_LAUNCH_FEE_TIER = QUICK_LAUNCH_FEE_TIER;
exports.QUICK_LAUNCH_TARGET_MCAP_USD = QUICK_LAUNCH_TARGET_MCAP_USD;
exports.QUICK_LAUNCH_TICK_SPACING = QUICK_LAUNCH_TICK_SPACING;
exports.QuickLaunchModule = QuickLaunchModule;
exports.RHLaunchpadABI = RHLaunchpadABI;
exports.RH_TICK_SPACING = RH_TICK_SPACING;
exports.RPC_ENDPOINTS = RPC_ENDPOINTS;
exports.RewardMode = RewardMode;
exports.STOCK_REWARD_ADDRESSES = STOCK_REWARD_ADDRESSES;
exports.STOCK_REWARD_CHAIN_ID = STOCK_REWARD_CHAIN_ID;
exports.STOCK_TARGET_MCAP_USD = STOCK_TARGET_MCAP_USD;
exports.STOCK_UNIVERSE = STOCK_UNIVERSE;
exports.STOCK_V4_FEE_TIER = STOCK_V4_FEE_TIER;
exports.STOCK_V4_GUARD_WINDOW_SECS = STOCK_V4_GUARD_WINDOW_SECS;
exports.STOCK_V4_TICK_SPACING = STOCK_V4_TICK_SPACING;
exports.Side = Side;
exports.StockKeeperABI = StockKeeperABI;
exports.StockRewardLauncherV2ABI = StockRewardLauncherV2ABI;
exports.StockRewardLauncherV4ABI = StockRewardLauncherV4ABI;
exports.StockRewardModule = StockRewardModule;
exports.StockRewardVaultABI = StockRewardVaultABI;
exports.TokenFactoryABI = TokenFactoryABI;
exports.TokenModule = TokenModule;
exports.TradingModule = TradingModule;
exports.TransactionError = TransactionError;
exports.V3Dex = V3Dex;
exports.V3LaunchModule = V3LaunchModule;
exports.V3PairToken = V3PairToken;
exports.V3_DEFAULT_FEE_TIER = V3_DEFAULT_FEE_TIER;
exports.V3_FEE_TIERS = V3_FEE_TIERS;
exports.V3_MAX_SQRT_RATIO = V3_MAX_SQRT_RATIO;
exports.V3_MIN_SQRT_RATIO = V3_MIN_SQRT_RATIO;
exports.V3_TICK_SPACING = V3_TICK_SPACING;
exports.ValidationError = ValidationError;
exports.WEIGHT_TOTAL_BPS = WEIGHT_TOTAL_BPS;
exports.WalletRequiredError = WalletRequiredError;
exports.WethUsdAggregatorABI = WethUsdAggregatorABI;
exports.buildStockLaunchParamsV4 = buildStockLaunchParamsV4;
exports.computeFairLaunchParams = computeFairLaunchParams;
exports.computeV3FairLaunchParams = computeV3FairLaunchParams;
exports.draftToBasketEntries = draftToBasketEntries;
exports.equalWeights = equalWeights;
exports.getAddresses = getAddresses;
exports.getHookOSV3Addresses = getHookOSV3Addresses;
exports.getQuickLaunchAddresses = getQuickLaunchAddresses;
exports.getRpcPool = getRpcPool;
exports.getStockRewardAddresses = getStockRewardAddresses;
exports.splitForTax = splitForTax;
exports.stockBySymbol = stockBySymbol;
exports.tickSpacingForFee = tickSpacingForFee;
