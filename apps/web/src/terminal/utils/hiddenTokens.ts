/**
 * Test / seed tokens that must NEVER surface in the production UI.
 *
 ...
 * user-facing token/pool/ticker list; only real tokens (ETH, USDG, WETH, HYPE,
 * WOKB, …) show. Matched by symbol, case-insensitive.
 */
