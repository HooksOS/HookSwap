...
Guides for people trading and providing liquidity on HookSwap.
...
> **Reality check:** the HookSwap contracts are deployed, but live quoting depends on the
> routing backend being online and pools holding real liquidity. Some chains may show
> "no route" until liquidity is seeded. See the [FAQ](./faq.md).
